...
# 脚本运行选项设置
need_download_models=False  #是否需要重新下载模型，此过程很慢，如果已经下载过将该值设置成False
opt_dir = "/home/liuyiqing01/Paddle-Lite/lite/api/python/bin/paddle_lite_opt"  #opt工具目录
output_dir = "./output"
...
class OpenvinoModels(ModelsCollection):
    """
        ************** Openvino Models **************
    """
    def __init__(self):
        # super().__init__()
        self.fastscnn = {"name" : ["fastscnn"], "url" : ["https://paddlelite-demo.bj.bcebos.com/NNAdapter/models/PaddleSeg/v2.4/fastscnn_cityscapes_1024x1024_160k.tar.gz"]} 
        self.BERT = {"name" : ["BERT"], "url" : ["https://paddlelite-demo.bj.bcebos.com/NNAdapter/models/PaddleNLP/bert_base_uncased.tgz"]}
        self.ERNIE = {"name" : ["ERNIE "], "url" : ["https://paddlelite-demo.bj.bcebos.com/NNAdapter/models/PaddleNLP/ernie_1.0.tgz"]}
        self.ERNIE_TINY = {"name" : ["ERNIE_TINY"], "url" : ["https://paddlelite-demo.bj.bcebos.com/NNAdapter/models/PaddleNLP/ernie_tiny.tar.gz"]}
        self.MOBILENETV2 = {"name" : ["mobilenet_v2"], "url" : ["https://paddlelite-demo.bj.bcebos.com/NNAdapter/models/PaddleClas/MobileNetV2.tgz"]}
        self.MOBILENETV3_LARGE = {"name" : ["mobilenetV3_large"], "url" : ["https://paddlelite-demo.bj.bcebos.com/NNAdapter/models/PaddleClas/MobileNetV3_large_x1_0.tgz"]}
        self.MOBILENETV3_small = {"name" : ["mobilenetV3_small"], "url" : ["https://paddlelite-demo.bj.bcebos.com/NNAdapter/models/PaddleClas/MobileNetV3_small_x1_0.tgz"]}
        self.RESNET50 = {"name" : ["resnet50"], "url" : ["https://paddlelite-demo.bj.bcebos.com/NNAdapter/models/PaddleClas/ResNet50.tgz"]}
        self.BISNETV2 = {"name" : ["bisnetV2"], "url" : ["https://paddlelite-demo.bj.bcebos.com/NNAdapter/models/PaddleSeg/v2.3/bisenet.tar.gz"]}
        self.SSD_MOBILENETV3_LARGE = {"name" : ["ssd_moblenet_v3_large"], "url" : ["https://paddlelite-demo.bj.bcebos.com/NNAdapter/models/PaddleDetection/static/ssdlite_mobilenet_v3_large.tar.gz"]}
        self.SSD_MOBILENETV3_SMALL = {"name" : ["ssd_mobilenet_v3_small"], "url" : ["https://paddlelite-demo.bj.bcebos.com/NNAdapter/models/PaddleDetection/static/ssdlite_mobilenet_v3_small.tar.gz"]}
        self.YOLOV3_DARKNET53 = {"name" : ["yolov3_darknet53"], "url" : ["https://paddlelite-demo.bj.bcebos.com/NNAdapter/models/PaddleDetection/yolov3_darknet53_270e_coco.tgz"]}
        self.YOLOV3_MOBILENET_V1 = {"name" : ["yolov3_mobilenet_v1"], "url" : ["https://paddlelite-demo.bj.bcebos.com/NNAdapter/models/PaddleDetection/yolov3_mobilenet_v1_270e_coco.tgz"]}
        self.YOLOV3_MOBILENET_v3 = {"name" : ["yolov3_mobilenet_v3"], "url" : ["https://paddlelite-demo.bj.bcebos.com/NNAdapter/models/PaddleDetection/yolov3_mobilenet_v3_large_270e_coco.tgz"]}
        self.YOLOV3_RESNET50_VD = {"name" : ["yolov3_resnet50_vd"], "url" : ["https://paddlelite-demo.bj.bcebos.com/NNAdapter/models/PaddleDetection/yolov3_r50vd_dcn_270e_coco.tgz"]}
        self.PPYOLO_MBV3 = {"name" : ["ppyolo_mbv3"], "url" : ["https://paddlelite-demo.bj.bcebos.com/NNAdapter/models/PaddleDetection/v2.3/ppyolo_mbv3_large_coco.tar.gz"]}
        self.PPYOLO_R50VD_DCN = {"name" : ["ppyolo_r50vd_dcn"], "url" : ["https://paddlelite-demo.bj.bcebos.com/NNAdapter/models/PaddleDetection/v2.3/ppyolo_r50vd_dcn_1x_coco.tar.gz"]}
        self.PPYOLO_TINY = {"name" : ["ppyolo_tiny"], "url" : ["https://paddlelite-demo.bj.bcebos.com/NNAdapter/models/PaddleDetection/v2.3/ppyolo_tiny_650e_coco.tar.gz"]}
        self.PPYOLO_V2_R50VD_DCN = {"name" : ["ppyolov2_r50vd_dcn"], "url" : ["https://paddlelite-demo.bj.bcebos.com/NNAdapter/models/PaddleDetection/v2.3/ppyolov2_r50vd_dcn_365e_coco.tar.gz"]}
        self.UNET = {"name" : ["U-Net"], "url" : ["https://paddlelite-demo.bj.bcebos.com/NNAdapter/models/PaddleSeg/v2.3/unet_cityscapes_1024x512_160k.tar.gz"]}
        self.OCRNet = {"name" : ["OCRNet"], "url" : ["https://paddlelite-demo.bj.bcebos.com/NNAdapter/models/PaddleSeg/v2.3/ocrnet.tar.gz"]}
        self.deeplabv3p_resnet50_os8_humanseg_512x512_100k_with_softmax = {"name" : ["deeplabv3p_resnet50_os8_humanseg_512x512_100k_with_softmax"], "url" : ["https://paddlelite-demo.bj.bcebos.com/NNAdapter/models/PaddleSeg/v2.3/deeplabv3p_resnet50_os8_humanseg_512x512_100k_with_softmax.tar.gz"]}
        self.ch_ppocr_server_v2_0_rec = {"name" : ["ch_ppocr_server_v2_0_rec"], "url" : ["https://paddlelite-demo.bj.bcebos.com/NNAdapter/models/PaddleOCR/v2.3/ch_ppocr_server_v2.0_rec_infer.tar.gz"]}
        self.ch_ppocr_server_v2_0_det = {"name" : ["ch_ppocr_server_v2_0_det"], "url" : ["https://paddlelite-demo.bj.bcebos.com/NNAdapter/models/PaddleOCR/v2.3/ch_ppocr_server_v2.0_det_infer.tar.gz"]}
        self.ch_PP_OCRv2_det = {"name" : ["ch_PP_OCRv2_det"], "url" : ["https://paddlelite-demo.bj.bcebos.com/NNAdapter/models/PaddleOCR/v2.3/ch_PP-OCRv2_det_infer.tar.gz"]}
        self.ch_PP_OCRv2_rec = {"name" : ["ch_PP_OCRv2_rec"], "url" : ["https://paddlelite-demo.bj.bcebos.com/NNAdapter/models/PaddleOCR/v2.3/ch_PP-OCRv2_rec_infer.tar.gz"]}
        self.ch_ppocr_mobile_v2_det = {"name" : ["ch_ppocr_mobile_v2_det"], "url" : ["https://paddlelite-demo.bj.bcebos.com/NNAdapter/models/PaddleOCR/ch_ppocr_mobile_v2.0_det_infer.tgz"]}
        self.ch_ppocr_mobile_v2_rec = {"name" : ["ch_ppocr_mobile_v2_rec"], "url" : ["https://paddlelite-demo.bj.bcebos.com/NNAdapter/models/PaddleOCR/ch_ppocr_mobile_v2.0_rec_infer.tgz"]}
    ...
    def GetUseOptTransModelsList(self):
        use_opt_trans_models_list = [
            ...
            self.ERNIE_TINY,
            self.MOBILENETV2,
            self.MOBILENETV3_small,
            self.MOBILENETV3_LARGE,
            self.RESNET50,
            self.BISNETV2,
            self.SSD_MOBILENETV3_LARGE,
            self.SSD_MOBILENETV3_SMALL,
            self.YOLOV3_DARKNET53,
            self.YOLOV3_MOBILENET_V1,
            self.YOLOV3_MOBILENET_v3,
            self.YOLOV3_RESNET50_VD,
            self.PPYOLO_MBV3,
            self.PPYOLO_R50VD_DCN,
            self.PPYOLO_TINY,
            self.PPYOLO_V2_R50VD_DCN,
            self.UNET,
            self.OCRNet,
            self.deeplabv3p_resnet50_os8_humanseg_512x512_100k_with_softmax,
            self.ch_ppocr_server_v2_0_rec,
            self.ch_ppocr_server_v2_0_det,
            self.ch_PP_OCRv2_det,
            self.ch_PP_OCRv2_rec]
...
def transform(model_ops):
    #
    op_num = model_ops.shape[0]
    model_name = model_ops[model_ops['op']=='Paddle-Lite'].iloc[0][1] 
    for i in range(len(model_name)):
       model_ops.insert(model_ops.shape[1],model_name[i],value=0)
    for i in range(op_num):
       op_models = model_ops.loc[i]['model_name']
       for m_name in op_models:
           model_ops.loc[i,m_name] = 1
    model_ops.drop('model_name',axis=1,inplace=True)
...
if __name__ == '__main__':
    ...
    paddle_for_openvino_models = OpenvinoModels()
    opt_trans_model_list = [] 
    #opt_trans_model_list.extend(paddle_for_openvino_models.GetUseOptTransModelsList())
